        ...
        <div class="row">
            ...
            <div class="col-md-8">
               <?php
                ...
                <hr>
                <img class="img-responsive" src="images/<?php echo $post_image; ?>" width="500" alt="">
                <hr>
            ...
            <?php } ?>
               ...
               <?php 
                ...
                $show_comment_on_post = mysqli_query($connection, $query);
                while ($row = mysqli_fetch_array($show_comment_on_post)){
